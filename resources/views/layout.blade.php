    ...
    <nav class="navbar navbar-expand-lg bg-body-tertiary">
        <div class="container-fluid">
            ...
            <ul class="navbar-nav me-auto">
                ...
                <li class="nav-item">
                    <a @class(['nav-link', 'active' => Route::currentRouteName() == 'my-article']) href="{{ route('my-article') }}" >{{ __('Nouvelle article') }}</a>
                </li>

                <li class="nav-item">
                    <a @class(['nav-link', 'active' => Route::currentRouteName() == 'files']) href="{{ route('files') }}" >{{ __('Répertoire') }}</a>
                </li>

                <li class="nav-item">
                @if ( Config::get('app.locale') == 'fr')
                <a class="nav-link" href="{{ route('langue', ['en']) }}">
                    {{ __('Anglais') }}
                </a>
                @else
                <a class="nav-link" href="{{ route('langue', ['fr']) }}">
                    {{ __('Français') }}
                </a>
                @endif
                </li>
